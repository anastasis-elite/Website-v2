...
export default function DashboardMoreMenu({program}:{program:'ember'|'ignite'|'phoenix'}){
  ...
  const items=[['Account','/dashboard/account'],['Photos','/dashboard/assessment/photos'],['Monthly Assessment','/dashboard/assessment/monthly'],['Progress History','/dashboard/assessment/measurements'],...(program==='phoenix'?[['Recipes','/dashboard/nutrition#phoenix-recipes']]:[]),['Help & Support','mailto:Anastasis.elite@gmail.com?subject=Account%20Support']] as string[][]
