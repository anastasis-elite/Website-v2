...
export default function DashboardMoreMenu({program}:{program:'ember'|'ignite'|'phoenix'}){
  ...
  const items=[['Account','/dashboard/account'],['Monthly Assessment','/dashboard/assessment/monthly'],...(program==='phoenix'?[['Recipes','/dashboard/nutrition#phoenix-recipes']]:[]),['Help & Support','mailto:Anastasis.elite@gmail.com?subject=Account%20Support']] as string[][]
