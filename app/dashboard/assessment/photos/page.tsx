  ...
  return (
    <main className="aos-photo-page">
      <div className="aos-photo-shell">
        <header className="aos-flow-hero"><p className="aos-eyebrow">Photos</p><h1>Track change without relying only on the scale.</h1><p>Upload progress photos for private comparison or posture photos when movement review is needed.</p></header>
