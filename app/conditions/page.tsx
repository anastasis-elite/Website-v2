  ...
  return (
    <main style={styles.pageStyle}>
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <h2 style={styles.sectionTitleStyle}>No Medical Diagnosis</h2>
        <p style={styles.bodyStyle}>
        ...
        <h2 style={styles.sectionTitleStyle}>Medical Conditions</h2>
        <p style={styles.bodyStyle}>
        ...
        <h2 style={styles.sectionTitleStyle}>Pregnancy &amp; Supervision</h2>
        <p style={styles.bodyStyle}>
        ...
        <h2 style={styles.sectionTitleStyle}>Injury &amp; Execution</h2>
        <p style={styles.bodyStyle}>
        ...
        <h2 style={styles.sectionTitleStyle}>Limitation of Liability</h2>
        <p style={styles.bodyStyle}>
        ...
        <h2 style={styles.sectionTitleStyle}>Assumption of Risk</h2>
        <p style={styles.bodyStyle}>
